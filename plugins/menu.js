...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let url = 'https://telegra.ph/file/bb235032497c153609d7e.jpg'
...
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        ...
                        mediaType: 2,
                        description: `⚘ ᴄʀᴇᴀᴛᴇ Reza Ketjehh`,
                        title: `💌 Ultah Owner : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`,
                        body: `⚘ ᴄʀᴇᴀᴛᴇ by Reza Ketjehh`,          previewType: 0,
                        thumbnail: await (await fetch(giflogo2)).buffer(),
                        mediaUrl: 'https://youtube.com/channel/UClo33d5kGNdUXOqwDb1UCNA'
