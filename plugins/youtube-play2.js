...
title: 'AUDIO',
body: 'YukiBot',         
previewType: 0, thumbnail: await (await fetch(`https://telegra.ph/file/bb235032497c153609d7e.jpg`)).buffer(),
...
let json = await res.json()
conn.sendFile(m.chat, json.result.url, 'error.mp4', `_Reza Ketcehh_`, m)}
}catch(e){
